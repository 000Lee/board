...
const PostItem = ({ post, isAuthenticated, user, boards }) => {
   //게시물 삭제 실행
      ...
      <div>
         <div style={styles.cardContainer}>
            <div
               ...
               style={{ ...styles.imageContainer, backgroundImage: `url(${process.env.REACT_APP_API_URL}${post.img})`, cursor: 'pointer' }}
            />
